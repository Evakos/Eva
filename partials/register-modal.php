...
<form method="post" class="woocommerce-form woocommerce-form-register register">
    ...
    <div class="field">
        <div class="control">
            ...
            <input type="text" class="input is-medium" name="username" id="reg_username" autocomplete="username"
    ...
    <div class="field">
        <div class="control">
            <input type="email" class="input is-medium" name="email" id="reg_email" autocomplete="email"
    ...
    <p class="woocommerce-FormRow form-row">
        ...
        <button type="submit" class="button is-block is-primary is-medium is-fullwidth" name="register"

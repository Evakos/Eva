	 ...
	 <div class='empty-icon'>
		...
		<p class="no_subscriptions">
			<?php if ( 1 < $current_page ) :
				...
				printf(__( 'Looks like you have no active subscriptions </br> %sstore%s', 'woocommerce-subscriptions' ), '<a href="' . esc_url( apply_filters( 'woocommerce_subscriptions_message_store_url', get_permalink( wc_get_page_id( 'shop' ) ) ) ) . '">', '</a>' );
			endif; ?>
		</p>
